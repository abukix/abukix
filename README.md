...
The technical substrate is **[`basecamp`](https://github.com/corestratum/basecamp)**, an open-source unified data, ML, and AI platform. 8 modules on a K8s substrate, running on laptop, homelab, or cloud with the same manifests. The build guide is **[`/root`](https://github.com/corestratum/root)**, a self-authored curriculum from Software Engineering Foundations to ML Platform / AI Infrastructure. `vantage` (one of basecamp's modules) is the unified web UI, the daily human surface once the platform is running.
...
- **8 `basecamp` modules**: [`ascent`](https://github.com/corestratum/ascent) (dev CLI + Workload operator) · [`crag`](https://github.com/corestratum/crag) (data tier) · [`vantage`](https://github.com/corestratum/vantage) (unified UI) · [`beacon`](https://github.com/corestratum/beacon) (on-call triage) · [`forge`](https://github.com/corestratum/forge) (Terraform + Crossplane IaC) · [`prism`](https://github.com/corestratum/prism) (LLM gateway) · [`loom`](https://github.com/corestratum/loom) (MCP fabric) · [`warden`](https://github.com/corestratum/warden) (AIOps operator)
...
- **[`basecamp`](https://github.com/corestratum/basecamp) umbrella**: GitOps repo composing the 8 modules
- **[`/root`](https://github.com/corestratum/root)**: the curriculum and build guide itself
